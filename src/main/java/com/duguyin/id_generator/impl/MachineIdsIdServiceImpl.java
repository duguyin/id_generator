...
import com.duguyin.id_generator.impl.populater.ResetPopulator;
import com.duguyin.id_generator.impl.provider.MachineIdsProvider;
...
public class MachineIdsIdServiceImpl extends IdServiceImpl {
    ...
    protected void initStoreFile() {
        ...
        try {
            System.out.println("machineId info store in <[" + storeFilePath + "]>");
    ...
    protected void storeInFile() {
        ...
        try {
            ...
            System.out.println("Write machineId info to File<[" + storeFile.getAbsolutePath() + "]> error");
